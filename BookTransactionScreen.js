...
export default class TransactionScreen extends React.Component {
    ...
    checkBookEligibility = async()=>{
      ...
      console.log("checkBookEligibility "+transactionType)
      return transactionType
    }
    checkStudentEligibilityForIssue = async()=>{
      console.log("checkStudentEligibilityForIssue")
      ...
      console.log("checkStudentEligibilityForIssue "+isStudentEligilible)
      return isStudentEligilible 
    }
    checkStudentEligibilityForReturn = async()=>{
      console.log("checkStudentEligibilityForReturn  here")
      var transactionref=null;
      try{
        console.log("this.state.scannedBookId "+this.state.scannedBookId)
      transactionref=await db.collection('transaction').where('bookId','==',this.state.scannedBookId).limit(1).get()
      }
      catch(error){
        console.log(error)
      }
      var isStudentEligilible=''
      console.log(" txn ref "+transactionref.docs)
      transactionref.docs.map((doc)=>{
        var lastBookTransction=doc.data()
        if(lastBookTransction.studentId===this.state.scannedStudentId){
          isStudentEligilible=true
        }
        else{
          isStudentEligilible=false
      ...
      console.log("checkStudentEligibilityForReturn "+isStudentEligilible)
      return isStudentEligilible
    }
